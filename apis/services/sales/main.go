...
import (
	...
	"github.com/AhmedBenAbdessalam/service/apis/services/api/debug"
	"github.com/AhmedBenAbdessalam/service/apis/services/sales/mux"
...
func run(ctx context.Context, log *logger.Logger) error {
	...
	cfg := struct {
		...
		Web struct {
			...
			DebugHost          string        `conf:"default:0.0.0.0:3020"`
